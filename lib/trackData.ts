...
const fsAiPhases: Phase[] = [
  ...fsCorePhases,
  {
    ...
    topics: [
      { id: 'ai-llm-intro', title: 'Introduction to LLMs & Transformers', estimatedHours: 6, url:'https://www.youtube.com/watch?v=3bPhDUSAUYI' },
      { id: 'prompt-engineering', title: 'Prompt Engineering', estimatedHours: 2, url:'https://www.youtube.com/watch?v=_ZvnD73m40o' },
      { id: 'openai-api', title: 'OpenAI / Anthropic API Integration', estimatedHours: 8 },
      { id: 'langchain', title: 'LangChain Fundamentals', estimatedHours: 2, url:'https://www.youtube.com/watch?v=nAmC7SoVLd8&t=22s' },
      { id: 'rag', title: 'RAG (Retrieval-Augmented Generation)', estimatedHours: 4, url:'https://www.youtube.com/watch?v=sVcwVQRHIc8' },
      { id: 'vector-db', title: 'Vector Databases (Pinecone)', estimatedHours: 2, url:'https://www.youtube.com/watch?v=AGKY_Q3GjRc&list=PLRLVhGQeJDTLiw-ZJpgUtZW-bseS2gq9-' },
      { id: 'ai-features', title: 'Building AI-Powered Features', estimatedHours: 4, url:'https://www.youtube.com/watch?v=PtETUYa3i2Q' },
      { id: 'huggingface', title: 'Hugging Face Models', estimatedHours: 6, url:'https://www.youtube.com/watch?v=00GKzGyWFEs&list=PLo2EIpI_JMQvWfQndUesu0nPBAtZ9gP1o' },
...
const fsDsPhases: Phase[] = [
  ...fsCorePhases,
  {
    ...
    topics: [
      { id: 'python-ds', title: 'Python for Data Science (Pandas, NumPy)', estimatedHours: 6, url:'https://www.youtube.com/watch?v=r-uOLxNrNk8' },
      { id: 'stats-probability', title: 'Statistics & Probability', estimatedHours: 3, url:'https://www.youtube.com/watch?v=XcLO4f1i4Yo' },
      { id: 'data-viz', title: 'Data Visualization (Matplotlib, Seaborn)', estimatedHours: 1.5, url:'https://www.youtube.com/watch?v=r-uOLxNrNk8' },
      { id: 'ml-fundamentals', title: 'Machine Learning Fundamentals', estimatedHours: 6, url:'https://www.youtube.com/watch?v=i_LwzRVP7bg' },
      { id: 'supervised-learning', title: 'Supervised Learning (Regression, Classification)', estimatedHours: 3 },
      { id: 'unsupervised-learning', title: 'Unsupervised Learning (Clustering)', estimatedHours: 2 },
      { id: 'sklearn', title: 'Scikit-learn', estimatedHours: 3, url:'https://www.youtube.com/watch?v=0B5eIE_1vpU' },
...
const fsDaPhases: Phase[] = [
  ...fsCorePhases,
  {
    ...
    topics: [
      { id: 'sql-analytics', title: 'SQL for Analytics (Advanced Queries)', estimatedHours: 6, url:'https://www.youtube.com/watch?v=7mz73uXD9DA' },
      { id: 'python-analysis', title: 'Python for Analysis (Pandas)', estimatedHours: 2, url:'https://www.youtube.com/watch?v=2uvysYbKdjM&t=71s' },
      { id: 'data-cleaning', title: 'Data Cleaning & Wrangling', estimatedHours: 1, url:'https://www.youtube.com/watch?v=bDhvCp3_lYw' },
      { id: 'tableau-powerbi', title: 'Tableau / Power BI Fundamentals', estimatedHours: 3, url:'https://www.youtube.com/watch?v=oIw8xJ1Fy3w' },
      { id: 'dashboard-design', title: 'Dashboard Design', estimatedHours: 6 },
      { id: 'ab-testing', title: 'A/B Testing & Experimentation', estimatedHours: 3, url:'youtube.com/watch?v=KZe0C0Qq4p0&pp=ygUdQS9CIFRlc3RpbmcgJiBFeHBlcmltZW50YXRpb24%3D' },
      { id: 'product-analytics', title: 'Product Analytics Concepts', estimatedHours: 1.5, url:'https://www.youtube.com/watch?v=5O4ST-R5ZVw' },
...
const fsDevopsPhases: Phase[] = [
  ...fsCorePhases,
  {
    ...
    weekRange: 'Weeks 26–32',
    topics: [
      { id: 'linux-shell', title: 'Linux & Shell Scripting', estimatedHours: 4, url:'https://www.youtube.com/watch?v=ROjZy1WbCIA' },
      { id: 'docker', title: 'Docker & Containerization', estimatedHours: 3, url:'https://www.youtube.com/watch?v=3c-iBn73dDE' },
      { id: 'kubernetes', title: 'Kubernetes Basics', estimatedHours: 2, url:'https://www.youtube.com/watch?v=s_o8dwzRlu4&t=104s' },
      { id: 'cicd', title: 'CI/CD Pipelines (GitHub Actions)', estimatedHours: 1.5, url:'https://www.youtube.com/watch?v=R8_veQiYBjI' },
      ...
      { id: 'iac', title: 'Infrastructure as Code (Terraform basics)', estimatedHours: 3, url:'https://www.youtube.com/watch?v=7xngnjfIlK4' },
